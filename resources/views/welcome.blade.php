...
<html>
	...
	<script>(function(d, s, id) {
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
							...
							<ul>
								...
								<li>
									...
									<ul>
										...
										<li><a href="main-v4.html">Home v4</a></li>
									</ul>
								</li>
								...
								<div class="tp-banner full-width-revolution">
									...
									<ul>
										<li data-transition="papercut" data-slotamount="7">
											<img src="{{ asset('assets/img/1920x490_slide1.jpg') }}" alt="">
										...
										<li data-transition="papercut" data-slotamount="7">
											<img src="{{ asset('assets/img/1920x490_slide2.jpg') }}" alt="">
										...
										<li data-transition="papercut" data-slotamount="7">
											<img src="{{ asset('assets/img/1920x490_slide3.jpg') }}" alt="">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-3 col-sm-12 animate-onscroll">
							...
							<div class="issue-block">
								...
								<div class="issue-image">
									<img src="{{ asset('assets/img/263x177_img10.jpg') }}" alt="">
								</div>

								<div class="issue-content">

									<h2>The Candidate</h2>
									<p>Interdum vitae, dapibus ac, scelerisque vitae, pede. Donec eget tellus non erat lacinia.</p>
						...
						<div class="col-lg-3 col-md-3 col-sm-12 animate-onscroll">
							...
							<div class="issue-block">
								...
								<div class="issue-image">
									<img src="{{ asset('assets/img/263x177_img11.jpg') }}" alt="">
								</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-12 animate-onscroll">
							...
							<div class="issue-block">
								...
								<div class="issue-image">
									<img src="{{ asset('assets/img/263x177_img12.jpg') }}" alt="">
								</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-12 animate-onscroll">
							...
							<div class="issue-block">
								...
								<div class="issue-image">
									<img src="{{ asset('assets/img/263x177_img13.jpg') }}" alt="">
								</div>
		...
		<!-- Banner Rotator -->
		<div class="banner-rotator full-width-banner animate-onscroll">
		...
		<div class="container">
			...
			<section class="section full-width-bg gray-bg var2">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="owl-carousel-container">
							...
							<div class="owl-header">
								...
								<h3 class="animate-onscroll">Latest News</h3>
							...
							<div class="owl-carousel" data-max-items="2">
								...
								<div>
									...
									<div class="blog-post animate-onscroll">
										...
										<div class="post-image">
											<img src="{{ asset('assets/img/263x177_img14.jpg') }}" alt="">
										</div>
								...
								<div>
									...
									<div class="blog-post animate-onscroll">
										...
										<div class="post-image">
											<img src="{{ asset('assets/img/263x177_img15.jpg') }}" alt="">
										</div>
					...
					<div class="col-sm-6">
						...
						<h3 class="animate-onscroll">Upcoming Events</h3>
						<div class="row">
							<div class="col-sm-6 animate-onscroll">

								<div class="blog-post">

									<div class="post-image m_bottom_20">
										<img src="{{ asset('assets/img/263x177_img16.jpg') }}" alt="">
									</div>

									<ul class="upcoming-events var2">
							...
							<div class="col-sm-6 animate-onscroll">
								...
								<ul class="upcoming-events var2">
									...
									<li>
										...
										<div class="event-content">
											<h6><a href="event-post-v2.html">Etiam cursus leo vel metus nulla</a></h6>
											<ul class="event-meta">
												<li><i class="icons icon-clock"></i> 4:00 pm - 6:00 pm</li>
												<li><i class="icons icon-location"></i> 340 W 50th St.New York</li>
											</ul>
									...
									<li>
										...
										<div class="event-content">
											<h6><a href="event-post-v2.html">Suspendisse sollicitudin velit sed leo</a></h6>
											<ul class="event-meta">
												<li><i class="icons icon-clock"></i> 4:00 pm - 6:00 pm</li>
												<li><i class="icons icon-location"></i> 340 W 50th St.New York</li>
											</ul>
			...
			<!-- Section -->
			<section class="section2 full-width-bg">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="owl-carousel-container no-margin-bottom">
							...
							<div class="owl-header">
								...
								<h3 class="animate-onscroll">Our sponsors</h3>
							...
							<div class="owl-carousel" data-max-items="6">
								...
								<div>
									...
									<div class="animate-onscroll">
										...
										<div class="post-image">
											<img src="{{ asset('assets/img/165x100_brand2.jpg') }}" alt="">
										</div>
								...
								<div>
									...
									<div class="animate-onscroll">
										...
										<div class="post-image">
											<img src="{{ asset('assets/img/165x100_brand3.jpg') }}" alt="">
										</div>
								...
								<div>
									...
									<div class="animate-onscroll">
										...
										<div class="post-image">
											<img src="{{ asset('assets/img/165x100_brand4.jpg') }}" alt="">
										</div>
								...
								<div>
									...
									<div class="animate-onscroll">
										...
										<div class="post-image">
											<img src="{{ asset('assets/img/165x100_brand5.jpg') }}" alt="">
										</div>
								...
								<div>
									...
									<div class="animate-onscroll">
										...
										<div class="post-image">
											<img src="{{ asset('assets/img/165x100_brand6.jpg') }}" alt="">
										</div>
			...
			<section class="section full-width-bg gray-bg var2">
				...
				<div class="row no-margin-bottom">
					<div class="col-sm-12">
						...
						<div class="clearfix">
							...
							<div class="f-right">
								<a href="#" class="button button-follow-instagram m_top_20">Follow on Instagram</a>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<ul id="instagram-feed-2" class="clearfix"></ul>
			...
			<section class="section full-width-bg blue-bg">
				...
				<div class="row">
						...
						<form id="newsletter2" action="http://velikorodnov.com/html/candidate/php/newsletter-form.php" method="POST">
							...
							<div class="newsletter-form">
								...
								<div class="newsletter-title">
									<h5><strong>Sign up</strong> <br> for email updates</h5>
								</div>
					...
					<div class="col-sm-3 clearfix"><a href="#" class="donate-button f-right">Donate Now!</a></div>
		...
		<div class="customize-box">
			...
			<form id="customize-box">
				...
				<div class="background-image">
					<input type="radio" value="{{ asset('assets/img/background/1.jpg') }}" name="background-image-radio" id="background-img-radio-1" checked>
					<label for="background-img-radio-1"><img src="{{ asset('assets/img/background/1-thumb.jpg') }}" alt=""></label>

					<input type="radio" value="{{ asset('assets/img/background/2.jpg') }}" name="background-image-radio" id="background-img-radio-2">
					<label for="background-img-radio-2"><img src="{{ asset('assets/img/background/2-thumb.jpg') }}" alt=""></label>

					<input type="radio" value="{{ asset('assets/img/background/3.jpg') }}" name="background-image-radio" id="background-img-radio-3">
					<label for="background-img-radio-3"><img src="{{ asset('assets/img/background/3-thumb.jpg') }}" alt=""></label>
				</div>
